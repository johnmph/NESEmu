...
// STP, SLO, RLA, SRE, SRE, RRA, AXS, SAX, XAA, AHX, TAS, SHY, SHX, LAS, DCP, ISC, SBC($EB), ALR, ANC, ARR, LAX, NOP (other addressing modes), KIL (Kill instruction, opcodes which jams the machine)

...
#ifndef SOURCE_NESEMU_CARTRIDGE_MAPPER92_S_HPP
#define SOURCE_NESEMU_CARTRIDGE_MAPPER92_S_HPP
...
void Chip<TCpuHardwareInterface, TPpuHardwareInterface>::cpuReadPerformed(TCpuHardwareInterface &cpuHardwareInterface) {
    ...
    if ((address >= 0x8000) && (address < 0xC000)) {
        // Read first Prg-Rom bank
        cpuHardwareInterface.setDataBus(this->readPrgRom(address & 0x3FFF));
    }
    // Prg-Rom (last bank)
...
#endif /* SOURCE_NESEMU_CARTRIDGE_MAPPER92_S_HPP */

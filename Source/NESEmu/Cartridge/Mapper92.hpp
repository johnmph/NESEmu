...
#ifndef NESEmu_Cartridge_Mapper92_hpp
#define NESEmu_Cartridge_Mapper92_hpp
...
namespace NESEmu { namespace Cartridge { namespace Mapper92 {
    ...
    #include "Mapper92_s.hpp"
    
} } }

#endif /* NESEmu_Cartridge_Mapper92_hpp */
